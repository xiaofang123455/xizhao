...
<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			validateForm = $("#inputForm").validate({
				rules: {
						loginName: {remote: "${ctx}/sys/office/checkZipCode?oldZipCode=" + encodeURIComponent('${office.zipCode}')}//设置了远程验证，在初始化时必须预先调用一次。
					},
				messages: {
			...
			if('${office.useable }'!=''){
				$("#useable").val("${office.useable }");
			}
			$("#zipCode").validate().element($("#zipCode")); 
		});
	</script>
</head>
<body>
	<form:form id="inputForm" class="form-horizontal" action="${ctx }/sys/office/save" method="post" modelAttribute="office">
		<form:hidden path="id"/>
		   ...
		   <tbody>
		      <tr>
		       ...
		       <tr>
		         ...
		         <td class="width-35"><form:input path="code" class="form-control"  maxlength="50"/></td>
		      </tr>
		       <tr>
		      ...
		      <tr>
		         ...
		         <td class="width-35"><form:input  path="address" class="form-control"  maxlength="50"/></td>
		      </tr>
		      <tr>
		         <td class="width-15 active"><label class="pull-right">邮政编码:</label></td>
		         <td class="width-35"><form:input  path="zipCode" class="form-control"   maxlength="50"/>
		         <input id="oldZipCode" name="oldZipCode" type="hidden" value="${office.zipCode}">
		         </td>
		         <td  class="width-15 active"><label class="pull-right">负责人:</label></td>
		         <td class="width-35"><form:input path="master" class="form-control"   maxlength="50"/></td>
		      </tr>
		      <tr>
		         <td class="width-15 active"><label class="pull-right">电话:</label></td>
		         <td class="width-35"><form:input  path="phone" class="form-control" maxlength="50"/></td>
		         <td  class="width-15 active"><label class="pull-right">传真:</label></td>
		         <td class="width-35"><form:input  path="fax" class="form-control"   maxlength="50"/></td>
		      </tr>
		      <tr>
		         <td class="width-15 active"><label class="pull-right">邮箱:</label></td>
		         <td class="width-35"><form:input  path="email" class="form-control email"   maxlength="50"/></td>
		         <td  class="width-15 active"><label class="pull-right">备注:</label></td>
		         <td class="width-35"><form:textarea id="remarks" path="remarks" maxlength="200" class="form-control" rows="3"/></td>
		      </tr>
	      </tbody>
	      </table>
	</form:form>
