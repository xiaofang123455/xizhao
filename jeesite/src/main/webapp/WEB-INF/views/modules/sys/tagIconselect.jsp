...
<div id="icons">
			    ...
			    <h2 class="page-header">30 New Icons in 4.6</h2>
			     <ul class="the-icons">
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-american-sign-language-interpreting"></i> american-sign-language-interpreting</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-asl-interpreting" ></i>asl-interpreting <span class="text-muted">(alias)</span></li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-assistive-listening-systems" ></i>assistive-listening-systems</li>
